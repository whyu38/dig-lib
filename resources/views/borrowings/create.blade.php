...
<div class="card">
    ...
    <form action="{{ route('borrowings.store') }}" method="POST" novalidate>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="borrow_code" id="borrow_code" class="form-control" placeholder="Masukkan kode pinjam" required>
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="date" name="return_date" id="return_date" class="form-control" placeholder="Opsional">
        </div>
